# Generated by Django 5.0.4 on 2024-09-30 16:33
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('subadmin_id', models.CharField(blank=True, default='cb0519cd', max_length=8, unique=True)),
                ...
                ('subadmin_last_login', models.DateTimeField(default=datetime.datetime(2024, 10, 1, 16, 32, 59, 375345, tzinfo=datetime.timezone.utc), verbose_name='last login')),
